...
def calculate(vna_obj, outer_source, inner_source, port, filename):
    # Get corrections
    ...
    assert outer_corr.is_valid and not outer_corr.is_empty
    assert inner_corr.is_valid and not inner_corr.is_empty
